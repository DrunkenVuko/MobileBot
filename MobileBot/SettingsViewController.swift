...
class SettingsViewController : UIViewController, UITextFieldDelegate {
    ...
    @IBAction func save(sender: UIBarButtonItem) {
        ...
        if bcm.connections.count > 0 {
            ...
            bcm.connetionWithIp(ipTextField.text, port: (portTextField.text as! NSString).integerValue);
        }
    ...
    @IBAction func connect(sender: UIButton) {
        ...
        if bcm.connections.count > 0 {
            ...
            connection = bcm.connetionWithIp(ipTextField.text, port: (portTextField.text as! NSString).integerValue);
        }
